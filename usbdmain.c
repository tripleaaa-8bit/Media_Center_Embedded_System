...
/*----------------------------------------------------------------------------
  MP3 Player - Play audio, if up pressed, exit function via TIMER0_IRQn
 *----------------------------------------------------------------------------*/
int mp3_player (void)
{
  ...
  LPC_TIM0->TCR = 1;					/* TC0 Enable */
	...
	GLCD_Bitmap (10, 50, 300, 171, (unsigned char *)SPLASH_pixel_data);							
	GLCD_DisplayString(0, 0, __FI, "  Use potentiometer to ");							
	GLCD_DisplayString(1, 0, __FI, "  adjust volume  ");								
